...
helpURL = "https://www.mathworks.com/help/releases/R2025a/index.html";


% 2. What does the command 'clear all' do?
%
% Answer: clears all variables in the workspace
%
...
doc version  %<- command goes here

% 5. Write some commands that would return a list of all of the available 
% functions in the image processing toolbox? 
listOfAllIPT = readlines ("imageProcessingToolbox.m");
% Madison helped direct me on this one, I tried using the url
% like question 1 but that didn't work. I looked at what AI would say and I
% was heavily frustrated with how easy that solution was.
% It gave me "ver", enter, "help images"....
...
%
% Answer: corrcoef (correlation coefficient): It determines the correlation 
% between two variables and would be helpful for creating
% charts.
...
%
% Answer: "for" loop repeats only as many times as you enter. The "while"
% loop is conditional, meaning the code will recur only when the conditions
% are met. 
% 
...
%
% Answer: Not a Number; occurs when there is not a value attributed to that
% integer in an array. 
% Example: 0/0
...
base2 = 6;
height = 4;
trapArea = ((base1 + base2) / 2) * height; % Variable name is "trapArea", 
% formula for trapezoid entered as a function of the variable.
